...
client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '야동선배 바보' }, status: 'online' })
});
...
client.on("guildMemberAdd", (member) => {
  ...
  member.addRole(guild.roles.find(role => role.name == "normaluser"));
});
...
client.on('message', (message) => {
  ...
  if(message.content == 'embed') {
    let img = 'https://cdn.discordapp.com/attachments/690864572063678475/745938742719676426/1_1.gif';
    let embed = new Discord.RichEmbed()
      .setTitle('타이틀')
      .setURL('http://www.naver.com')
      .setAuthor('소스', img, 'http://www.naver.com')
      .setThumbnail(img)
      .addBlankField()
